                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
									...
									<td><?= $data['tgl_masuk'] ?></td>
									 <td><?= $data['jabatan'] ?></td>
                                    <td>
                                        <a href="report/datakaryawan_satu.php?id=<?= $data['id'] ?>" target="_blank" class="btn btn-info btn-xs">
...
<div id="cetak_perbulan" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/datakaryawan_perbulan.php" method="post">
        <h4>Pilih bulan </h4>
...
<div id="cetak_pertahun" class="modalDialog">
    <div>
        ...
        <form  target="_blank" action="report/datakaryawan_pertahun.php" method="post">
        <h4>Pilih tahun</h4>
        <select name="tahun" class="form-control">
          <?php
            for ($i=substr(date("d-m-Y"),6,4); $i > substr(date("d-m-Y"),6,4)-5; $i--) { ?>
